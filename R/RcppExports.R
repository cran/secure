...
secure_SURR_Rcpp <- function(X, Y, Au, Av, bu, bv, uk, vk, dk, nlambda, control) {
    .Call('secure_secure_SURR_Rcpp', PACKAGE = 'secure', X, Y, Au, Av, bu, bv, uk, vk, dk, nlambda, control)
}

secure_SURR_Rcpp_ortho <- function(X, Y, Au, Av, bu, bv, uk, vk, dk, nlambda, control) {
    .Call('secure_secure_SURR_Rcpp_ortho', PACKAGE = 'secure', X, Y, Au, Av, bu, bv, uk, vk, dk, nlambda, control)
}

secure_SURR_miss_Rcpp <- function(X, Y, naInd, Au, Av, bu, bv, uk, vk, dk, nlambda, control) {
    .Call('secure_secure_SURR_miss_Rcpp', PACKAGE = 'secure', X, Y, naInd, Au, Av, bu, bv, uk, vk, dk, nlambda, control)
}
